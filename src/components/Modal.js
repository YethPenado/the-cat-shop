  ...
  return (
    <ul className="card-container--modal">
      <li className="card__item card__item--modal">
        <button onClick={props.functionClose} className="close-button close-button--cart">X</button>
        ...
        <p className="product-description left-space">
          <span className="bold-txt">Description: </span>{props.propitem.description}
        </p>
